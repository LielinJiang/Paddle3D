...
class PETRHead(nn.Layer):
    ...
    def get_coords(self):
        ...
        self.register_buffer('coords', coords, persistable=False)
    ...
    def position_embeding_export(self,
                                 img_feats,
                                 img_metas,
                                 masks=None,
                                 lidar2img=None):
    ...
    def export_forward(self, mlvl_feats, img_metas, time_stamp=None):
        ...
        if self.with_position:
            coords_position_embeding, _ = self.position_embeding_export(
